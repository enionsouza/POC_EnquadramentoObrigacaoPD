...
public class VerificaObrigacoesProposta {
    static void exec(List<Double> aportes_ICTsPublicas, List<Double> aportes_ICTsPrivadas, List<Double> Obrigacao_PD) {
        ...
        if (aportesIncI >= ObrigacaoIncI) {
            System.out.println("Empresa adimplente conf inc I do § 1º do art 5º do Decreto 10.521/2020 - Forma Proposta!");
        }
        else System.out.println("Empresa inadimplente conf inc I do § 1º do art 5º do Decreto 10.521/2020 - Forma Proposta!");

        if (aportesIncVI >= ObrigacaoIncVI) {
            System.out.println("Empresa adimplente conf inc VI do § 1º do art 5º do Decreto 10.521/2020 - Forma Proposta!");
        }
        else System.out.println("Empresa inadimplente conf inc VI do § 1º do art 5º do Decreto 10.521/2020 - Forma Proposta!");
